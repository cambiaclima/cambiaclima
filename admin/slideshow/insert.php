		...
		<main class="container-md shadow-sm bg-white pt-3" role="main">
			<form action="aggiungi.php" method="post">
			  <fieldset class="form-group">
				...
				<div class="row">
					<div class="col">
						<label for="invia_uno">Seleziona gli articoli da inserire nello slideshow</label>
					</div>
					<div class="col-2">
						<input class="btn btn-primary" type="submit"  name="invia_uno" id="invia_uno" value="Conferma"/>
					</div>
				</div>
			</form>
