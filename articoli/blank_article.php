  ...
  <body>
    ...
    <main class="container-md shadow-sm bg-white" role="main">
      ...
      <div class = "row align-items-center">
        <div class="col-lg-6 offset-lg-1 immagine" align = "left"><!-- mettere il padding per questioni stilistiche-->
          <?php
        ...
        <div class="col-lg" id = "spazio_sottotitolo" align = "center">
          <h5><?php echo popups($row["breve_descr"]); ?></h5>
        </div><!-- Colonna 3 riga 3-->
      </div><!-- Row 3 -->
      <div class = "row contenuto">
        <div class = "col-lg-10 offset-lg-1 " id = "spazio_testo_articolo"><!-- altro spazio tattico per il corpo dell'articolo -->
          <p>
